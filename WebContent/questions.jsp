...
select question.id as id ,title,date,user_id,name,sname,count from sub_cat,question,user where question.sub_cat_id = sub_cat.id AND question.user_id = user.id AND sub_cat_id = '<c:out value="${id }"></c:out>' </sql:query>
